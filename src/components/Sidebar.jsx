...
import { LayoutDashboard, Key, BookOpen, Home, Sparkles, Terminal, Activity, Zap } from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-72 border-r border-slate-800/80 bg-slate-950/60 backdrop-blur-xl p-5 min-h-[calc(100vh-65px)] flex flex-col justify-between select-none">
